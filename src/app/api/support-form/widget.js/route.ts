...
(function () {
  ...
  style.textContent = [
    ...
    ".st-support-panel{width:min(100%,420px);max-height:calc(100vh - 40px);overflow:auto;border-radius:12px;background:#fff;color:#18181b;box-shadow:0 24px 80px rgba(15,23,42,.28);font:14px system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif}",
    ...
    ".st-support-title{margin:0;font-size:18px;line-height:1.25;font-weight:700}",
    ".st-support-intro{margin:6px 0 0;color:#71717a;line-height:1.4}",
    ...
    ".st-support-label{font-size:12px;font-weight:600;color:#3f3f46}",
    ".st-support-input,.st-support-textarea{width:100%;box-sizing:border-box;border:1px solid #d4d4d8;border-radius:8px;padding:10px 11px;font:14px system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#18181b}",
    ".st-support-textarea{min-height:120px;resize:vertical}",
